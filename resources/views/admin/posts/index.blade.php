                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Post Title</th><th>Post Image</th><th>Post author</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($posts as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->post_title }}</td><td><img src="{{asset('public/Upload/News/'.$item->post_image)}}" width="100px"/></td><td>{{ $item->post_author }}</td>
                                        <td>
